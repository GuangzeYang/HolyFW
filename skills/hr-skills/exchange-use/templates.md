...
```text
opencode run "Use the exchange-use skill, open the Exchange mailbox, send email, {recipient: manager@ndrtest.local, cc: programmer, subject: Onboarding pack, min_words: 400, attachment: C:\Users\hr\Desktop\offer.pdf}"
```
...
```text
opencode run "Use the exchange-use skill, open the Exchange mailbox, forward, {target: first email, recipient: accountancy, min_words: 400}"
```
