...
Allowed paths for HR: `\\172.16.24.11\Company_Data\HR-Private`, `\\172.16.24.11\Company_Data\Public`, `\\172.16.24.11\Company_Data\Exchange`. Do not write to accountancy, IT-Dev, or Management.

Map task paths such as `/Company_Data/HR-Private/file.txt` to `\\172.16.24.11\Company_Data\HR-Private\file.txt`.
