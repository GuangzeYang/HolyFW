...
```text
opencode run "Use the smb-access skill, connect to the SMB shared directory, use append to append text, {path: /Company_Data/IT-Dev/sprint-notes.txt, topic: update after manager reply, min_words: 300}"
```

```text
opencode run "Use the smb-access skill, connect to the SMB shared directory, use rename to rename a file, {path: /Company_Data/IT-Dev/sprint-notes.docx, new name: sprint-notes-final.docx}"
```

```text
opencode run "Use the smb-access skill, connect to the SMB shared directory, use delete to delete a file, {path: /Company_Data/IT-Dev/sprint-notes-final.docx}"
```
