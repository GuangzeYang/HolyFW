...
Allowed paths for Programmer: `\\172.16.24.11\Company_Data\IT-Dev`, `\\172.16.24.11\Company_Data\Public`, `\\172.16.24.11\Company_Data\Exchange`. Do not write to HR-Private, accountancy, or Management.

Map task paths such as `/Company_Data/IT-Dev/app.js` to `\\172.16.24.11\Company_Data\IT-Dev\app.js`.
