---
name: smb-access
description: Use when creating, viewing, updating, copying, moving, renaming, or deleting files on the company SMB share through PowerShell. Programmer may use IT-Dev, Public, and Exchange. Do not use a GUI explorer. Stop immediately on Access Denied.
---
...
Task paths look like `/Company_Data/IT-Dev/notes.txt`. Convert to UNC:
...
- `/Company_Data/IT-Dev/a.txt` → `\\172.16.24.11\Company_Data\IT-Dev\a.txt`
...
# Allowed trees (Programmer policy)

Write and delete only under:

- `\\172.16.24.11\Company_Data\IT-Dev`
- `\\172.16.24.11\Company_Data\Public`
- `\\172.16.24.11\Company_Data\Exchange`

Do **not** write, move-into, or delete under `HR-Private`, `accountancy`, or `Management` (Access Denied).

Other department folders may appear in a listing. **Do not use them.** Stick to IT-Dev / Public / Exchange.
...
3. Success: the listing includes `IT-Dev`, `Public`, and `Exchange`.
