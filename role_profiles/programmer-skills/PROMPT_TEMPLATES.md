...
English only. Run on the Programmer soldier host with the matching skill installed. Detailed copies live under `role_profiles/programmer-skills/`; the deployed copy is `~/.config/opencode/skills/`.
