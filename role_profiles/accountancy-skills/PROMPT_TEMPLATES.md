...
English only. Run on the Accountancy soldier host with the matching skill installed. Detailed copies live under `role_profiles/accountancy-skills/`; the deployed copy is `~/.config/opencode/skills/`.
